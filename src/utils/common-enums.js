module.exports = {
    ...
    filingDocumentStatuses: ['unprocessed', 'processing', 'processed', 'failed'],
    filingDocumentTypes: ['calculation', 'presentation', 'label', 'definition', 'instance', 'schema'],
    ...
    dateTypes: ['time-series', 'cross-sectional'],
